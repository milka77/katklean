<x-admin-layout>
    @section('content')
    <div class="w-full">
        <h1 class="text-center font-bold text-5xl pt-15 pb-7">Add Manual Booking</h1>

        <div class="h-full w-full  mx-auto my-5 border border-slate-300 bg-slate-100 p-3 rounded-xl">
            <form action="{{ route('booking.store') }}" method="post" class="grid  rounded-xl">
                ...
                <div class="grid ">
                    ...
                    <div class="grid grid-cols-1 gap-4 px-5 pt-2 pb-4 mb-3 border border-slate-300 rounded-xl bg-stone-50">
                        <p class="font-semibold text-center pt-2">Add/Change manually if needed</p>
                        <div class="flex flex-col">
