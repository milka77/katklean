  ...
  <div class="flex flex-col md:flex-row items-center justify-between gap-10 py-10 border-b border-gray-300/50 text-white">
    ...
    <div class="flex flex-wrap flex-col lg:flex-row justify-between w-2/3 md:w-1/2 gap-5 pb-1 md:pb-15">
      <div class="border-b border-slate-300 pb-2 md:border-none">
        <h3 class="font-semibold text-center md:text-left text-base text-gray-200 md:mb-5 mb-2">Quick links</h3>
        <ul class="text-sm space-y-1 text-center md:text-left">
      ...
      <div class="border-b border-slate-300 pb-2 md:border-none">
        <h3 class="font-semibold text-center md:text-left text-base text-gray-200 md:mb-5 mb-2">Working Hours:</h3>
