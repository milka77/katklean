<x-layout>
  ...
  <div class="h-full w-full md:w-1/3 mx-auto my-5">
    <form action="" method="post" class="grid">
      @csrf
      {{-- User delails --}}
      <div class="grid mt-3">
        <p class="font-semibold text-center bg-slate-200/50 border-y border-slate-300">Personal Details:</p>
      ...
      <div class="grid grid-cols-2 ">
        ...
        <div class="flex flex-col px-5 pb-2">
          ...
          <select class="border rounded-md border-slate-300 pl-2 py-1" name="frequency" id="frequency">
            ...
            <option value="bi-weekly" @if(old('frequency') == 'bi-weekly') selected @endif>Bi-weekly</option>
      ...
      <p class="font-semibold text-center bg-slate-200/50 border-y border-slate-300 mt-5 mb-3">Booking Details:</p>
      <div class="flex flex-col px-5 pb-2">
      ...
      <div class="flex flex-col pb-2 pt-1 mx-4">
        <p class="pl-2 py-2">Optional extras</p>
      ...
      <div class="grid">
        <div class="flex flex-col px-5 py-2">
          ...
          <textarea class="border rounded-md border-slate-300 pl-2 py-1" name="message" id="message" placeholder="Any specific instructions or requests?">{{ old('message') }}</textarea>
          @error('message')
            <p class="text-red-500 italic text-sm pl-2">{{ $message }}</p>
          @enderror
        </div>
        ...
        <div class="flex flex-row justify-between px-5 py-2">
            ...
            <p class="pl-2 text-sm">Please select this option if you want us to use our own cleaning equipment</p>
