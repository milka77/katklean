        ...
        <div class="border rounded-2xl border-slate-300 bg-stone-50 pt-3">
            ...
            <div class="p-4 ">
              ...
              <div class="flex flex-row justify-between px-2 py1">
                <p>Name: </p><p>{{ Auth()->user()->getFullNameAttribute() }}</p>
              </div>
              {{-- <div class="flex flex-row justify-between px-2 py1">
                <p>Last name: </p><p>{{ Auth()->user()->last_name }}</p>
              </div> --}}
              <div class="flex flex-row justify-between px-2 py1 mb-4">
              ...
              <div class=" py1 ">
                @if (Auth()->user()->addresses->first())
                  ...
                  <div class="flex flex-row justify-end px-2 py1">
                ...
                <p class="px-2 text-lg font-semibold">Bookings</p>
                <hr class="text-slate-300 mb-2">
                <div class=" py1 ">
                    @if (Auth()->user()->bookings->first())
                        ...
                        $nextBooking = Auth()->user()->bookings
                            ...
                            ->first();
                        @endphp
                        <p class="px-2 font-semibold pb-2">Your next upcoming booking:</p>
                        <ul class="flex flex-col px-2 pb-3">
                            <div class="flex flex-row justify-between">
                                <li>Booking date:</li>
                                <li> {{ $nextBooking->booking_date }} </li>
                            </div>
                            <div class="flex flex-row justify-between">
                                <li>Booking reference</li>
                                <li> {{ $nextBooking->reference }}</li>
                            </div>
                    ...
                    <div class="flex flex-row justify-center gap-4">
                        <button class="bg-slate-600 hover:bg-slate-700 text-white font-bold py-2 px-4 rounded cursor-pointer"><a href="{{ route('profile.bookings') }}">My bookings</a></button>
